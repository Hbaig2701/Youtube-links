...
export default function ClickTimeline({ videoId, linkId, links, onLinkChange }) {
  ...
  const { data, loading } = useFetch(
    () => appliedCustom
      ? getVideoClicks(videoId, 'custom', { startDate: appliedCustom.startDate, endDate: appliedCustom.endDate, linkId })
      : getVideoClicks(videoId, range, { linkId }),
    [videoId, appliedCustom ? 'custom' : range, appliedCustom?.startDate, appliedCustom?.endDate, linkId]
  );
